// <fileinfo name="PatientVisitInfoRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PatientVisitInfoRow"/> that 
	/// represents a record in the <c>PatientVisitInfo</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PatientVisitInfoRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public class PatientVisitInfoRow
	{
		private int _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PatientVisitInfoRow"/> class.
		/// </summary>
		public PatientVisitInfoRow()
		{
			// EMPTY
		}
	...
	} // End of PatientVisitInfoRow_Base class
} // End of namespace
