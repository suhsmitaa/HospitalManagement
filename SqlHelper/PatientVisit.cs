// <fileinfo name="PatientVisitCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PatientVisitCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="PatientVisitCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public class PatientVisitCollection
	{
		// Constants
		...
		/// <summary>
		/// Gets an array of all records from the <c>PatientVisit</c> table.
		/// </summary>
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public virtual PatientVisitRow[] GetAll()
		{
		...
		/// includes all records from the <c>PatientVisit</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>PatientVisit</c> table.
		/// </summary>
		...
		{
			return _db.CreateCommand("dbo._PatientVisit_GetAll", true);
		}

		/// <summary>
		/// Gets the first <see cref="PatientVisitRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="PatientVisitRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public PatientVisitRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			PatientVisitRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PatientVisitRow"/> objects that 
		...
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public PatientVisitRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public virtual PatientVisitRow[] GetAsArray(string whereSql, string orderBySql,
		...
		{
			string sql = "SELECT * FROM [dbo].[PatientVisit]";
		...
		/// <summary>
		/// Gets <see cref="PatientVisitRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>Id</c> column value.</param>
		/// <returns>An instance of <see cref="PatientVisitRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual PatientVisitRow GetByPrimaryKey(int id)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_GetByPrimaryKey", true);
			AddParameter(cmd, "Id", id);
			PatientVisitRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PatientVisitRow"/> objects 
		/// by the <c>FK__PatientVi__Docto__3B75D760</c> foreign key.
		/// </summary>
		/// <param name="doctorId">The <c>DoctorId</c> column value.</param>
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public PatientVisitRow[] GetByDoctorId(int doctorId)
		{
		...
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public virtual PatientVisitRow[] GetByDoctorId(int doctorId, bool doctorIdNull)
		{
		...
		/// return records by the <c>FK__PatientVi__Docto__3B75D760</c> foreign key.
		/// </summary>
		/// <param name="doctorId">The <c>DoctorId</c> column value.</param>
		/// <param name="doctorIdNull">true if the method ignores the doctorId
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_GetBy_DoctorId", true);
		...
		/// <summary>
		/// Gets an array of <see cref="PatientVisitRow"/> objects 
		/// by the <c>FK__PatientVi__Treat__3A81B327</c> foreign key.
		/// </summary>
		/// <param name="bedId">The <c>BedId</c> column value.</param>
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public PatientVisitRow[] GetByBedId(int bedId)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		public virtual PatientVisitRow[] GetByBedId(int bedId, bool bedIdNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.SqlCommand"/> object that can be used to 
		/// return records by the <c>FK__PatientVi__Treat__3A81B327</c> foreign key.
		/// </summary>
		/// <param name="bedId">The <c>BedId</c> column value.</param>
		/// <param name="bedIdNull">true if the method ignores the bedId
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_GetBy_BedId", true);
			AddParameter(cmd, "BedId", bedIdNull ? null : (object)bedId);
			return cmd;
		}

		/// <summary>
		/// Adds a new record into the <c>PatientVisit</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PatientVisitRow"/> object to be inserted.</param>
		public virtual void Insert(PatientVisitRow value)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_Insert", true);
		...
		/// <summary>
		/// Updates a record in the <c>PatientVisit</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PatientVisitRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(PatientVisitRow value)
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_Update", true);
			AddParameter(cmd, "PatientType",
				value.IsPatientTypeNull ? DBNull.Value : (object)value.PatientType);
			AddParameter(cmd, "DoctorId",
				value.IsDoctorIdNull ? DBNull.Value : (object)value.DoctorId);
		...
		/// <summary>
		/// Updates the <c>PatientVisit</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>PatientVisit</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>PatientVisit</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PatientVisitRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(PatientVisitRow value)
		{
			return DeleteByPrimaryKey(value.Id);
		}

		/// <summary>
		/// Deletes a record from the <c>PatientVisit</c> table using
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_DeleteByPrimaryKey", true);
			AddParameter(cmd, "Id", id);
			return 0 < cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Deletes records from the <c>PatientVisit</c> table using the 
		/// <c>FK__PatientVi__Docto__3B75D760</c> foreign key.
		/// </summary>
		/// <param name="doctorId">The <c>DoctorId</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.SqlCommand"/> object that can be used to
		/// delete records using the <c>FK__PatientVi__Docto__3B75D760</c> foreign key.
		/// </summary>
		/// <param name="doctorId">The <c>DoctorId</c> column value.</param>
		/// <param name="doctorIdNull">true if the method ignores the doctorId
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_DeleteBy_DoctorId", true);
			AddParameter(cmd, "DoctorId", doctorIdNull ? null : (object)doctorId);
			return cmd;
		}
		...
		/// <summary>
		/// Deletes records from the <c>PatientVisit</c> table using the 
		/// <c>FK__PatientVi__Treat__3A81B327</c> foreign key.
		/// </summary>
		/// <param name="bedId">The <c>BedId</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.SqlCommand"/> object that can be used to
		/// delete records using the <c>FK__PatientVi__Treat__3A81B327</c> foreign key.
		/// </summary>
		/// <param name="bedId">The <c>BedId</c> column value.</param>
		/// <param name="bedIdNull">true if the method ignores the bedId
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		{
			SqlCommand cmd = _db.CreateCommand("dbo._PatientVisit_DeleteBy_BedId", true);
			AddParameter(cmd, "BedId", bedIdNull ? null : (object)bedId);
			return cmd;
		}

		/// <summary>
		/// Deletes <c>PatientVisit</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>PatientVisit</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.SqlCommand"/> object.</returns>
		...
		{
			string sql = "DELETE FROM [dbo].[PatientVisit]";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>PatientVisit</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		public int DeleteAll()
		{
			return _db.CreateCommand("dbo._PatientVisit_DeleteAll", true).ExecuteNonQuery();
		}
		...
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		protected PatientVisitRow[] MapRecords(SqlCommand command)
		{
		...
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		protected PatientVisitRow[] MapRecords(SqlDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="PatientVisitRow"/> objects.</returns>
		protected virtual PatientVisitRow[] MapRecords(SqlDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					PatientVisitRow record = new PatientVisitRow();
			...
			return (PatientVisitRow[])(recordList.ToArray(typeof(PatientVisitRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="PatientVisitRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="PatientVisitRow"/> object.</returns>
		protected virtual PatientVisitRow MapRow(DataRow row)
		{
			PatientVisitRow mappedObject = new PatientVisitRow();
		...
		/// the <c>PatientVisit</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "PatientVisit";
			DataColumn dataColumn;
	...
	} // End of PatientVisitCollection_Base class
}  // End of namespace
